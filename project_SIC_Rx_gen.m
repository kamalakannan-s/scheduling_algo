...
[tx_data_a, reconstruct_A]=reconstruct_ofdm_tx(rx_data_final_1, pilots_A, MOD_ORDER, number_of_bits, N_SC, CP_LEN, SC_IND_DATA, SC_IND_PILOTS, N_OFDM_SYMS, trellis_end_length);
[tx_data_b, reconstruct_B]=reconstruct_ofdm_tx(rx_data_final_2, pilots_B, MOD_ORDER, number_of_bits, N_SC, CP_LEN, SC_IND_DATA, SC_IND_PILOTS, N_OFDM_SYMS, trellis_end_length);
...
syms_f_mat_pc_A = syms_f_mat_pc_A - H11_sv.*reconstruct_A-H12_sv.*reconstruct_B;
syms_f_mat_pc_B = syms_f_mat_pc_B - H21_sv.*reconstruct_A-H22_sv.*reconstruct_B;
