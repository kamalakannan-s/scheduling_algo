function [rx_interferer_data, ifft_in_mat]=reconstruct_ofdm_tx(rx_interferer_data,pilots, MOD_ORDER, number_of_bits, N_SC, CP_LEN, SC_IND_DATA, SC_IND_PILOTS, N_OFDM_SYMS, trellis_end_length)

% Forward Error Correction
tx_data = double([rx_interferer_data zeros(1,trellis_end_length) ]);    % 8 bits padding
trel = poly2trellis(7, [171 133]);              % Define trellis
tx_code = convenc(rx_interferer_data,trel);            % convultional encoder
